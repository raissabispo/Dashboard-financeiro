...
if arquivo is not None:
    ...
    if not gastos_categoria.empty:
        ...
        cores = ["#F8BBD0", "#F48FB1", "#F06292", "#EC407A"]
        ax_pizza.pie(
            gastos_categoria,
    ...
    # -----------------------------
    def gerar_pdf(df_pdf, titulo, entradas, saidas, saldo, fig, imagem_path="image.png"):
        buffer = io.BytesIO()
        ...
        try:
            elementos.append(Image(imagem_path, width=400, height=200))
        except:
            pass
    ...
    # Botão PDF
    # -----------------------------
    pdf = gerar_pdf(df_mes, titulo_mes, total_entradas, total_saidas, saldo, fig_resumo, "image.png")
    st.download_button(
        label="📄 Exportar PDF",
        data=pdf,
